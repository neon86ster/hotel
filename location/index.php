...
<title>Location, Oasis Baan Saen Doi Spa Resort</title>
			...
			<div id="page-content">
					...
					<div id="sidemenu">
						<div id="navigation">
							<ul class="top-level">
								...
								<li class="active"><a class="active" href="index.php">LOCATION</a></li>
				...
				<a target="_blank" href="http://www.tripadvisor.com/Hotel_Review-g293917-d661439-Reviews-Oasis_Baan_Saen_Doi_Spa_Resort-Chiang_Mai.html" onmouseover="changeimg('tripadvisor','../images/tripadvisor-hover.png')" onmouseout="changeimg('tripadvisor','../images/tripadvisor.png')"><img id="tripadvisor" src="../images/tripadvisor.png"></a>
					...
					<div id="location_main">
						...
						<h1><span></span>location</h1>
						</div>
						<div id="paragraph_location">
						<p>
						Nestled in the inside Ban Nai Fun Village, on Chonpratan Road, Chiang Mai. The Oasis Baan Saen Doi Spa Resort is close enough to Doi Suthep Mountian for a great view but far enough from the city center to escape its hectic lifestyle. It is within close proximity to Chiang Mai International Airport, next to The Royal Floral Rachapruek Garden and Chiang Mai Night Safari.
						</p>
						<div class="location_body_line"></div>
						</div>

						<div id="location-right">
						<div id="location-map"></div>
						</div>
							<div id="paragraph_address">
							<p>
							199/135 Moo 3,Baan Nai Fun 2,Mae Hia, Muang, Chiang Mai  50100 Thailand <br>
							Tel. +6653920199
							</p>
							</div>
								<div id="location-left">
									...
									<div id="download-location">
												<fieldset>
													<legend>
														<font color="#7D2F01" style="font-size:15px;"><b>Oasis Baan Saen Doi</b></font> Spa Resort Official Map
													</legend>
													<div id="chiangmai-map"></div>
													
												</fieldset>
											
											<div id="download-map" class="down-load-map-item"><a target="blank"  href="./images/baansaendoimap.jpg"><font color="#ffffff"><b>Download Map</b></font></a></div>
									</div>
								</div>
				...
				<script type="text/javascript">
				var locations = [
				['', 18.745999, 98.931423, 1]
				];
				var map = new google.maps.Map(document.getElementById('chiangmai-map'), {
				zoom: 14,
				center: new google.maps.LatLng(18.745999, 98.931423),
				scrollwheel: false,
				...
				window.open("http://goo.gl/maps/jzMOU");
				}
				})
				(marker, i));
				}
