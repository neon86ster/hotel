...
<title>Oasis Baan Saen Doi Spa Resort</title>
			...
			<div id="page-content">
				<div id="side">
					...
					<div id="sidemenu">
						<div id="navigation">
							<ul class="top-level">
								<li  class="active"><a  class="active" href="home.php">WELCOME</a></li>
								<li><a href="./room/index.php">ROOMS & SUITES</a></li>
								<li><a href="./sparelaxation/index.php">SPA & RELAXATION</a></li>
								<li><a href="./restaurant/index.php">RESTAURANTS</a></li>
				...
				<div id="main">
						...
						<div id="main_title">
						<h1><span></span>Oasis Baan Saen Doi Spa Resort</h1>
						</div>
						<div class="body_line"></div>
						<div id="paragraph">
						<p><font color="#7E3C24" style="font-size:14px;"><b>A sweet boutique</b></font> retreat with all the upscale amenities … whether you are looking for a very private, romantic getaway, a spa vacation, or a staging point for your Thailand adventure there is only one clear choice – Oasis Baan Saen Doi Spa Resort. Located at the foot of the Doi Suthep Mountain, this retreat is your secret Chiang Mai hideaway. From its luxurious Lanna architecture, original High Land 
and Southeast Asian art to its breathtaking views, every detail caters to your senses. Each of the lavishly decorated, spacious guest rooms has a beautifully decorated bathroom, and a private veranda. The upstairs terrace has a traditional pavilion that affords a panoramic view of Doi Suthep Mountain. With the Lanna hospitality, you will lack for nothing. Everything about the Oasis Baan Saen Doi Resort & Spa is superb.</p>
						</div>
						
						<div class="body_underline"></div>
					<div id="iconlink" class="iconlink">
						
						<a href="./specialoffer/index.php" onmouseover="changeimg('specialoffer','./images/specialoffer-hover.png')" onmouseout="changeimg('specialoffer','./images/specialoffer.png')"><img id="specialoffer" src="./images/specialoffer.png"></a>
						&nbsp&nbsp<img border="0" src="./images/sep.png" alt="png1" width="5" height="70" />&nbsp&nbsp
						<a href="./discoverchiangmai/index.php" onmouseover="changeimg('cm','./images/cm-hover.png')" onmouseout="changeimg('cm','./images/cm.png')"><img id="cm" src="./images/cm.png"></a>
						&nbsp&nbsp<img border="0" src="./images/sep.png" alt="png1" width="5" height="70" />&nbsp&nbsp
						<a href="./sparelaxation/index.php" onmouseover="changeimg('spawell','./images/spawell-hover.png')" onmouseout="changeimg('spawell','./images/spawell.png')"><img id="spawell" src="./images/spawell.png"></a>
