...
<meta name="keywords" content="spa,oasis,Chiang Mai,Bangkok,Phuket,Pataya,massage,treatments,body,complete,beauty,mai,treatment,guests,chiang,home,air,allow,senses,hand,customer,comment,scrubs,perfect,picked,specialists,tranquility,menu,genuine,ancient,operate,pleasure, Bangkokoasis,wellness destination" />
<meta name="description" content="Massage, Oasis Spa, Chiang Mai, Bangkok, Phuket and Pattaya, Thailand">
...
<div class="wrapper">
		<div class="header">
				...
				<h1><span></span>The Oasis Luxury Thailand, Simply Unforgettable</h1>
					<div id="position2">
							...
							<ul class="nav">
								...
								<li><a href="../spawellness/index.php">SPA & WELLNESS</a></li>
							</ul>
							</div> 
			...
			<div id="reservation">
					...
					<div id="guarantee">Best Rates Guaranteed</div>
			</div>
			...
			<div id="page-content">
				...
				<a target="_blank" href="http://www.facebook.com/Oasisfanpage" onmouseover="changeimg('facebook','../images/facebook-hover.png')" onmouseout="changeimg('facebook','../images/facebook.png')"><img id="facebook" src="../images/facebook.png"></a>
				...
				&nbsp<img border="0" src="../images/social_sep.png" alt="png1" width="5" height="27" />&nbsp
				<a target="_blank" href="" onmouseover="changeimg('flicker','../images/flicker-hover.png')" onmouseout="changeimg('flicker','../images/flicker.png')"><img id="flicker" src="../images/flicker.png"></a>
