...
<title>Rooms & Suites,  Oasis Baan Saen Doi Spa Resort</title>
					...
					<div id="sidemenu">
						<div id="navigation">
							<ul class="top-level">
								...
								<li class="active"><a class="active" href="index.php">ROOMS & SUITES</a></li>
...
a#link:hover{
	text-decoration:underline;
				...
				<div id="rate_main">
						...
						<div id="navmenu">
							<ul>
							 <li><a id="room" href="../room/index.php"><h1><span class="active"></span>Rooms & Suites</h1></a></li>
						...
						<div id="content">
							...
							<p style="border-top : 1px dotted #c8c8c8;padding:15px 0 0 0">		
								...
								if(($i+1)%5!=0){
									$style = "clear:both;height:5px;border-top: solid 1px #ebebeb;";
								}else{
									$style = "";
								}
								?>
								...
								<div id="room-box">
									<div id="box-pic" style="width:155px;">
										<a class="various fancybox.ajax"  href="detail.php?roome=<?=$rs[$i]["room_id"]?>">
										<img src="../<?=$rs[$i]["pic1"]?>" width="155px;" height="80px">
										</a>
									</div>
									<div id="box-detail">
										<a class="various fancybox.ajax"  href="detail.php?roome=<?=$rs[$i]["room_id"]?>">
										<img id="name-head" src="../<?=$rs[$i]["pic2"]?>" >
										</a>
										<p>
										<?=$rs[$i]["cover_detail"]?>
										</p>
										<a class="various fancybox.ajax" id="readmore" href="detail.php?roome=<?=$rs[$i]["room_id"]?>"></a>
									</div>
									<div id="box-book">
										<a id="booknow" href="<?=$rs[$i]["link"]?>"></a>
									</div>
								</div>
