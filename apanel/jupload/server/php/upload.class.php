...
class UploadHandler
{
    ...
    function __construct($options=null) {
		...
		$this->options = array(
			...
			'upload_dir' => '../../../../images/'.$_REQUEST['juploadpage'].'/'.$_REQUEST['juploadid'].'/',
			'upload_url' => '../../../../images/'.$_REQUEST['juploadpage'].'/'.$_REQUEST['juploadid'].'/',
    ...
    protected function set_file_delete_url($file) {
        $file->delete_url = $this->options['script_url']
			...
			.'&juploadpage='.$_REQUEST['juploadpage'].'&juploadid='.$_REQUEST['juploadid'];
    ...
    public function post() {
		...
		if(!file_exists($this->options['upload_dir'])){
			$flgCreate = mkdir($this->options['upload_dir']);
		}
