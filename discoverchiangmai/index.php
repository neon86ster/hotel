...
<title>Discover Chiang Mai, Oasis Baan Saen Doi Spa Resort</title>
		...
		<div class="header">
				...
				<h1><span></span>The Oasis Luxury Thailand, Simply Unforgettable</h1>
					<div id="position2">
							...
							<ul class="nav">
								...
								<li><a class="active" href="index.php">DISCOVER CHIANG MAI</a></li>
			...
			<div id="page-content">
				...
				<div id="discover_main">
						...
						<div id="discover_title">
						<h1><span></span>Discover Chiang Mai</h1>
						</div>
						<div id="paragraph_discover">
						<p>
						Chiang Mai, with in driving distance of the Golden Triangle, is the perfect destination for insightful travelers. It is large enough to have anything you want yet small enough to find everything. The center of a fascinating ancient culture, it nevertheless has a modern infrastructure, even super highways, and all the contemporary conveniences you enjoy. 
						</p>
						<div class="discover_body_line"></div>
						</div>
