...
<title>Meet & Celebrate,Oasis Baan Saen Doi Spa Resort</title>
...
<div class="wrapper">
		<div class="header">
			...
			<div id="page-content">
					...
					<div id="sidemenu">
						<div id="navigation">
							<ul class="top-level">
								...
								<li class="active"><a class="active" href="index.php">MEET & CELEBRATE</a></li>
				...
				<div id="meet_main">
						<div id="meet_title">
						<h1><span></span>Meet & celebrate</h1>
						</div>
						<div id="paragraph_meet">
						<p>
Why go to a huge impersonal hotel for a small meeting or party when you can receive the personalize attention of a boutique retreat and still enjoy all the amenities at the Oasis Baan Saen Doi Spa Resort? We are your small event gathering point.<br><br>

Whether it is a small business meeting or training session ... family celebration ... small party or other event, we can make it everything you want it to be. We do what big hotels geared for large conventions fail to do by recognizing what they never can - the tiniest detail of your small event is important to you. It is the difference between the work of a craftsman and the product of an assembly line. Allow us to craft your next gathering into an event that is "simply unforgettable." Contact us at 053920199 for more details.
						
						</p>
						<div class="meet_body_line"></div>
						</div>
						
						<div id="meet_pic">
						<div id="meet_dis1"></div>
						<div id="meet_dis2"></div>
						<div id="meet_dis3"></div>
