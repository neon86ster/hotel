...
$sql="select * from special_offer order by special_id desc ";
$rs=$eg->get_data($sql);
...
<title>Special Offers,  Oasis Baan Saen Doi Spa Resort</title>
			...
			<div class="header_logo">
				<h1><span></span>The Oasis Luxury Thailand, Simply Unforgettable</h1>
					<div id="position2">
							...
							<ul class="nav">
								<li><a class="active" href="index.php">SPECIAL OFFERS</a></li>
				...
				<div id="rate_main">
						...
						<div id="navmenu">
							<ul>
							 ...
							 <li><a id="rate" href="../rate/index.php"><h1><span></span>Rates</h1></a></li>
							 <li><a id="offer" href="../specialoffer/index.php"><h1><span class="active"></span>Special Offers</h1></a></li>
							</ul>
						</div>
						
						<div id="content">
							<p>
							Take advantage of Oasis Baan Saen Doi Spa Resort special, limited time promotions and you and your friends can enjoy the best for less ...
							share the deals with your acquaintances. Throughout the year, we make available a variety of Special Offers that provide significant discounts 
							on room rates, spa treatments, and other services. Bookmark this page and check it often. Today we are offering ...
							</p>
							
							<div style="border-top : 1px dotted #c8c8c8;padding:15px 0 0 0;margin: 20px 0 0 0;height:195px;">
							<div style="margin:0 auto;width:670px;">
							<?
							$cnt=0;
							for($i=0;$i<$rs["rows"];$i++){
								if(($i+1)%3!=0){
									$style = "border-right : 1px dotted #c8c8c8;";
								}else{
									$style = "";
								}
							?>
								<div id="offer-box" style="<?=$style?>">
										<h4><?=$rs[$i]["cover_title"]?></h4>
										<a rel="group" class="various fancybox.ajax" id="readmore" href="detail.php?offer=<?=$rs[$i]["special_id"]?>">
										<img style="margin:10px;cursor:pointer;" src="../<?=$rs[$i]["cover_pic"]?>" height="163px" width="142px;">
										</a>
								</div>
							<?
							}
